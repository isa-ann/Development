...
# Remove whitespace
# day_no_whitespace = day.replace(" ", "")
# print(day_no_whitespace)  # Output: TUESDAY
# new_day = day.strip()
# print(new_day)
# print(len(new_day))
...
test_2 = email[]
print('Test 2: Does the email have exactly one "@" symbol, at the fifth-to-last index or earlier?, test)
