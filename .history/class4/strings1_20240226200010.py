...
# word_6 ='I\tam\ta\ttab' # expandtabs
# print(word_6.expandtabs(15))
...
ex_11 = '123456' # Check for decimals? #isdecimal
print(ex_11.isdecimal())

# isdigit() Are all characters digits? #isdigit
