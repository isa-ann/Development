...
'''
my_string = 'Supercalifragilisticexpialidocious'
total = 0 # initializes total count

for m in my_string:
    total += 1 

print (f'there are {total}'letters in your word, {my})    
...
# string = "Good, Job"
# count = 0 # maintain the count of the letter in our string

# for char in string:
#     if char.isalpha():  # Check if the character is a letter
#         count += 1 # incrementing count for every letter in our string
# print(f"There are {count} letters in the word {string}")
