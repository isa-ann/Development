...
# # Option 1
# unique_colors = [] # initialize an empty list called unique_colors
# for c in colors:  # initiates a loop that iterates through each element in the colors list
#     if c not in unique_colors:
#         unique_colors.append(c) # If the current element c is not already in the list, we append it to the  list. 
# print(unique_colors) # after the loop completes, we print out the unique_colors list



# # Option 2 - Using Sets
# unique_colors = list(set(colors)) # set(colors) creates a set from the list colors
