...
for c in colors:  # initiates a loop that iterates through each element in the colors list
    if c not in unique_colors:
        unique_colors.append(c) # If the current element c is not already in the list, we append it to the  list. This ensures that only unique elements are added to the list.
print(unique_colors)
