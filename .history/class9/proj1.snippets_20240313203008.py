...
# Predefined regular expression pattern for uppercase letters
uppercase_test_regex = r'[A-Z]'

# Function to check if a string contains at least one uppercase letter
# def contains_uppercase(s):
#     return bool(re.search(uppercase_test_regex, s))
...
# Define system username and password
sys_username = 'simonsays123'
sys_password = 'fido1950'

def login(username, password):
    # Check if the provided username and password match the system credentials
...
def main():
    ...
    if login(username, password):
        ...
        # Add your loop handling code here
    else:
